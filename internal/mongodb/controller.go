...
func sendVerificationEmail(email, userID string) error {
	...
	mailer.SetBody("text/html", fmt.Sprintf("Please click the following link to verify your account: <a href='https://aitunder-0spx.onrender.com/verify?userID=%s'>Verify</a>", userID))
